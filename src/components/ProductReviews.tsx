        ...
        <div className="py-2">
          <div className="flex items-center gap-4 w-full">
            <Image
              ...
              height={100}
              width={100}
              className="rounded-full border border-gray-800 size-14 lg:size-16 object-cover"
            />
            <div className="flex justify-between w-full">
              <div>
                <h6 className="font-bold text-gray-700">Mahin Hasan</h6>
                <p className="text-xs lg:text-sm text-gray-600">2026-04-02</p>
              </div>
          ...
          <div className="px-6 py-2">
            <p className="text-xs lg:text-sm text-gray-600 tracking-wider leading-6 text-justify">
              ...
              text ever since the 1500. Lorem Ipsum is simply dummy text of the
